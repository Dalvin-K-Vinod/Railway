...
$cdquery="SELECT * FROM classseats";
$cdresult=mysqli_query($conn,$cdquery);
echo "
<table>
<thead><td>Train_no</td><td>Starting_Point</td> <td>Destination_Point</td><td>doj</td><td>class</td><td>fare</td><td>seatsleft</td><td></td></thead>
";

while ($cdrow=mysqli_fetch_array($cdresult)) 
{
	echo "
<tr><td>".$cdrow['trainno']."</td><td>".$cdrow['sp']."</td><td>".$cdrow['dp']."</td><td>".$cdrow['doj']."</td><td>".$cdrow['class']."</td><td>".$cdrow['fare']."</td><td>".$cdrow['seatsleft']."</td>
";
}
echo "</table>";
...
<br>
<span><form action="admin_login.php" method="post" class="form"><center>
<input type="submit" class="login-button" name="sname" value=" Back" required><br>
</form>
</body>
</html>