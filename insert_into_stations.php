...
<br>
<span><form action="insert_into_station.php" method="post" class="form"><center>
<input type="text" name="sname" placeholder=" Add New Station" required><br><br>
<input type="submit" class="login-button" value="Add"></span>
<?php
