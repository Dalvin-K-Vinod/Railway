...
?>
<div align="center"> 
<form action="enquiry_result.php" method="post" class="form">
<h1 class="login-title">Ticket Booking</h1><center> 

Starting Point: <br><select id="sp" name="sp" required>
...
Destination Point: <br><select id="dp" name="dp" required>
...
Date of Journey: <br><input type="date" name="doj"  required><br><br>
<input type="submit" class="login-button">

</form>
<br><br><a href="http://localhost/railway/index.htm">Home Page</center></a>
</body>
</html>
